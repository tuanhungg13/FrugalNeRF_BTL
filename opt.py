...
def config_parser(cmd=None):
    ...
    parser.add_argument('--patch_size', type=int, default=2, help='Size of the patch for sampling and depth smoothness loss')
    ...
    parser.add_argument("--novel_batch_size", type=int, default=4096)
    parser.add_argument("--n_iters", type=int, default=30000)

    parser.add_argument('--dataset_name', type=str, default='blender',
                        choices=['blender', 'llff', 'nsvf', 'dtu', 'realestate10k','tankstemple', 'own_data'])
    ...
    parser.add_argument("--TV_weight_app", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--TV_weight_color_density", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--Sparse_Depth_weight", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--Self_Depth_weight", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--Dist_weight", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--Depth_Smooth_weight", type=float, default=0.0,
                        help='loss weight') 
    parser.add_argument("--MR_color_weight", type=float, default=1.0,
                        help='loss weight')
    parser.add_argument("--LR_color_weight", type=float, default=1.0,
                        help='loss weight')
    parser.add_argument("--warping_patch_size", type=int, default=5,
                        help='loss weight')
    parser.add_argument("--Dense_Depth_weight", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--Occ_loss_weight", type=float, default=0.0,
                        help='occlusion loss weight') 
    ...
    ## frame options
    parser.add_argument("--train_frame_num", type=int, nargs='+', help='frame id')
    parser.add_argument("--test_frame_num", type=int, nargs='+', help='frame id')
    ...
    parser.add_argument('--down_sampling_ratio', type=int, action="append")
    ...
    parser.add_argument("--reg_rate", type=float, default=0.0,
                        help='The number of initial intervals to include in the regularization mask.')
    parser.add_argument("--wb_prior", type=bool, default=False,
                        help='If True, a prior based on the assumption of white or black backgrounds is used. (for occ loss)')
    parser.add_argument("--wb_rate", type=float, default=0.0,
                        help='The range of RGB values considered to be a white or black background.')
