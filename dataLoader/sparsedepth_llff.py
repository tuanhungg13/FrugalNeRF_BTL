...
def pipeline(scene, base_path, n_views):
    ...
    res = os.popen( 'colmap feature_extractor --database_path database.db --image_path images --SiftExtraction.peak_threshold 0.0001 --SiftExtraction.max_image_size 4032 --SiftExtraction.max_num_features 32768 --SiftExtraction.estimate_affine_shape 1 --SiftExtraction.domain_size_pooling 1 --ImageReader.single_camera 1').read()
    ...
    os.system('colmap point_triangulator --database_path database.db --image_path images --input_path created  --output_path triangulated --Mapper.tri_ignore_two_view_tracks 0  --Mapper.ba_local_max_num_iterations 40 --Mapper.ba_local_max_refinements 3 --Mapper.ba_global_max_num_iterations 100')
    ...
    os.system('colmap patch_match_stereo --workspace_path dense --PatchMatchStereo.geom_consistency true')
...
for scene in ['fern', 'flower', 'fortress',  'horns',  'leaves',  'orchids',  'room',  'trex']:
    pipeline(scene, base_path = '/home/linjohnss/nerf_llff_data/', n_views = 2)  # please use absolute path!
